...
DEFAULT_DATASET_ROOT = SENTINELBLUE_GITHUB_DIR.parent / "Datasets" / "Life jacket ON.v16i.yolov11"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Remap Life Jackets labels and build a total folder.")
    parser.add_argument(
        "--dataset-root",
        type=Path,
        default=DEFAULT_DATASET_ROOT,
        help="Path to the Life jacket ON.v16i.yolov11 dataset folder.",
    )
