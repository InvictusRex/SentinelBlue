...
EXTERNAL_ROOT = Path("../../Datasets/Buoy")
...
EXTERNAL_BUOY_CLASS_ID = 0
SENTINELBLUE_BUOY_CLASS_ID = 3
...
def remap_label_and_copy(label_path, image_path):
    ...
    with open(label_path, "r") as f:
        for line in f:
            ...
            if class_id == EXTERNAL_BUOY_CLASS_ID:
                parts[0] = str(SENTINELBLUE_BUOY_CLASS_ID)
...
print(f"Total external buoy samples copied into SentinelBlue TRAIN: {total_copied}")